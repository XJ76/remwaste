...
export function SelectedSkipSummary({ skip, totalPrice }: SelectedSkipSummaryProps) {
  ...
  return (
    <Card className="bg-gradient-to-r from-slate-800 to-slate-900 text-white border-0 shadow-xl sm:shadow-2xl overflow-hidden relative">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
          <div className="flex items-center space-x-3 sm:space-x-6">
            ...
            <div>
              ...
              <p className="text-slate-200 font-medium text-sm sm:text-base">{skip.ideal_for}</p>
          ...
          <div className="text-left sm:text-right w-full sm:w-auto">
            ...
            <p className="text-slate-200 text-sm sm:text-base">including VAT & delivery</p>
